<?php
  ...
  if ( !Authentication::whoCanAccess('user') ) {
    ...
    CSRF::generateToken('post_add_form'); 
  ...
  if ( $_SERVER ["REQUEST_METHOD"] === 'POST' )
    {
        ...
        $rules=[
            'title'=>'required',
            'csrf_token'=>'post_add_form_csrf_token',
        ];
        ...
        if ( !$error ){
            // step 4: update user  
            POST::add(
                $_SESSION['user']['id'],//get data user id
                $_POST['title'],//title
            ...
            CSRF::removeToken( 'post_add_form' );
...
<div class="container mx-auto my-5" style="max-width: 700px;">
    ...
    <div class="card mb-2 p-4">
        ...
        <form method="POST" action="<?php echo $_SERVER["REQUEST_URI"]; ?>">
            ...
            <input type="hidden" name="csrf_token" value="<?php echo CSRF::getToken('post_add_form') ?>">
        </form>
    </div>
